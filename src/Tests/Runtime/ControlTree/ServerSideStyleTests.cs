...
@"<dot:LinkButton data-manyhandlers />")
        ...
        public void StylesRemove()
        {
            ...
            e = Parse("<dot:Repeater DataSource={value: 'abcd'}><SeparatorTemplate><span Styles.Tag=remove /></SeparatorTemplate> <ItemTemplate>x</ItemTemplate></dot:Repeater>", checkErrors: false);
            Assert.AreEqual(1, e.Content.Count);
